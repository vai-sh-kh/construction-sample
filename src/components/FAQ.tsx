...
export default function FAQ() {
  ...
  return (
    <section ref={sectionRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        {/* Left Side */}
        <div className={`lg:col-span-4 transition-all duration-1000 ease-out ${
          ...
          <p className="text-gray-500 text-sm leading-relaxed max-w-sm mb-8">
            Find quick answers to some of the most common inquiries about our services, process, and
        ...
        <div className={`lg:col-span-8 lg:pl-10 transition-all duration-1000 ease-out delay-200 ${
          isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
        }`}>
              ...
              >
                <div className="flex items-center justify-between w-full">
                  ...
                  <span className="w-8 h-8 rounded-full flex items-center justify-center text-gray-400 group-hover:text-black transition-colors">
                    <span
                      className={`material-icons-outlined text-xl transition-transform duration-300 ${
                        openId === faq.id ? "rotate-45" : "group-hover:rotate-45"
                      }`}
                    >
                      add
                    </span>
