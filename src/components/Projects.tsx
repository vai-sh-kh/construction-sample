...
export default function Projects() {
  ...
  return (
    ...
    >
      ...
      <div 
        ref={headerRef}
        className={`flex flex-col lg:flex-row justify-between items-start lg:items-end mb-12 gap-8 transition-all duration-1000 ease-out transition-transform duration-300 ${
      ...
      >
        <div className="max-w-2xl">
          ...
          <p className="text-gray-600 text-sm lg:text-[15px] font-light max-w-lg mt-4">
            Every project is a reflection of our dedication to quality, innovation, and purpose.
            From urban landmarks to essential community spaces — we build with integrity and
            intention.
          </p>
        </div>
        ...
        {PROJECTS.map((project, index) => (
          ...
          >
            ...
            <div className="absolute top-4 right-4 bg-white/20 backdrop-blur-md border border-white/10 rounded-full w-10 h-10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
              <span className="material-icons-outlined text-white text-sm transform -rotate-45">
                arrow_forward
              </span>
            </div>
            ...
            <div className="absolute bottom-0 left-0 p-8 w-full">
              <h3 className="text-white text-xl font-bold mb-2 leading-snug">{project.title}</h3>
